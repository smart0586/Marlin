...
#define STRING_CONFIG_H_AUTHOR "(Sergio Martinez, 08-20-2020 SKR 1.4 Turbo)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
 ...
 // #define DEFAULT_Kd 57.38
    ...
    // FLSUN QQ-S, with E3D V6 Hotend, Titanium Heatbreak, and Hardened Steel Nozzle after PID Auto tune
...
#define DELTA
  ...
  #define DELTA_HEIGHT 356.90            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.09, 0.00, -0.41 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 140.84              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.11, -0.24, 0.13 } // Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 830 }  // default steps per unit
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 200, 415 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 600, 90 } // ...or, set your own edit limits
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -20.76 }
