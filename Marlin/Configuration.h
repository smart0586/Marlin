...
#define STRING_CONFIG_H_AUTHOR "(SM, 6-Jan-21, E3Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Marlin 2.0.6 Ender-3 Pro BTT SKR Mini & BLTOUCH"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  30.13,  30.13 }
    #define DEFAULT_Ki_LIST {   3.16,   3.16 }
    #define DEFAULT_Kd_LIST { 71.85, 71.85 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 67.8 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.5, 10, -2.43 }
